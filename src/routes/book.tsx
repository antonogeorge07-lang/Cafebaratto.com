...
function BookPage() {
  ...
  return (
    <main className="min-h-screen bg-oak-100 px-4 py-10">
      <div className="mx-auto max-w-xl">
        ...
        {/* BookingModal renders as a fixed overlay; on /book it's the whole page. */}
        <BookingModal key={kind} open kind={kind} onClose={() => { /* no-op on standalone page */ }} />
      </div>
    </main>
  );
}
