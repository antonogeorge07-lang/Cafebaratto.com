...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Digital Leap Forward is an application for managing ICT and Digitalisation Support within an organization." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Digital Leap Forward is an application for managing ICT and Digitalisation Support within an organization." },
